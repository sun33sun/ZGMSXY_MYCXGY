				...
				switch (e.label) {
					case 0:
						return o
							? [
									4,
									r.audioWorklet.addModule(
										''.concat(n, '/processor.worklet.js')
									),
							  ]
							: [3, 2]
					case 1:
					...
					case 2:
						return [
							4,
							new Worker(''.concat(n, '/processor.worker.js')),
						]
					case 3:
		...
		return (
									...
									(l.port.onmessage = function (t) {
										s &&
											...
											e.onStop &&
												...
												t.data.isLastFrame &&
													e.onStop(e.audioBuffers))
									}),
									o
										? f.connect(l)
										: (((p = d.createScriptProcessor(
												0,
												1,
												1
												...
												l.port.postMessage({
													type: 'message',
													data: e.inputBuffer.getChannelData(
														0
													),
												})
										  }),
			...
			(a.prototype.stop = function () {
				...
				null === (e = this.audioWorklet) ||
					...
					null === (t = this.audioTracks) ||
						void 0 === t ||
						t[0].stop(),
					null === (o = this.audioContext) ||
						void 0 === o ||
						o.suspend()
			}),
			a
