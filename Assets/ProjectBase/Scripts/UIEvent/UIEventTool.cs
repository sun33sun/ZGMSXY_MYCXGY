...
public class UIEventTool
{
	...
	public static void RemoveAllEventTrigger(GameObject insObject)
	{
		EventTrigger eventTrigger = insObject.GetComponent<EventTrigger>();
		if (eventTrigger)
		{
	...
	public static void RemoveEventTrigger(GameObject insObject, EventTriggerType eventType)
	{
		EventTrigger eventTrigger = insObject.GetComponent<EventTrigger>();
		if (eventTrigger)
		{
	...
	public static void RemoveEventTriggerEvent(GameObject insObject, EventTriggerType eventType, UnityAction<BaseEventData> unityAction)
	{
		EventTrigger eventTrigger = insObject.GetComponent<EventTrigger>();
		if (eventTrigger)
		{
